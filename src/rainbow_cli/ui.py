"""UI components and interactive elements for Rainbow CLI."""
...
# Create Typer app with custom banner group
app = typer.Typer(
    name="rainbow",
    help="Setup tool for Rainbow spec-driven development projects",
...
def callback(ctx: typer.Context):
    ...
    if ctx.invoked_subcommand is None and "--help" not in sys.argv and "-h" not in sys.argv:
        show_banner()
        console.print(Align.center("[dim]Run 'rainbow --help' for usage information[/dim]"))
        console.print()
