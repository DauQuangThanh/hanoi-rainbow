...
NEW_PLAN="$FEATURE_DESIGN"  # Alias for compatibility with existing code
AGENT_TYPE="${1:-}"
...
CURSOR_FILE="$REPO_ROOT/.cursor/rules/rainbow-rules.mdc"
QWEN_FILE="$REPO_ROOT/QWEN.md"
AGENTS_FILE="$REPO_ROOT/AGENTS.md"
WINDSURF_FILE="$REPO_ROOT/.windsurf/rules/rainbow-rules.md"
KILOCODE_FILE="$REPO_ROOT/.kilocode/rules/rainbow-rules.md"
AUGGIE_FILE="$REPO_ROOT/.augment/rules/rainbow-rules.md"
ROO_FILE="$REPO_ROOT/.roo/rules/rainbow-rules.md"
