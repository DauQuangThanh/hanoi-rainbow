...
**CRITICAL**: Never commit directly to the main branch. All feature work must be done in feature branches. Automatically generate a 'docs:' prefixed git commit message (e.g., 'docs: add implementation plan for user authentication', 'docs: update technical design for payment integration') and commit upon completion.
