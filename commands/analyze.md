...
- If CRITICAL issues exist: Recommend resolving before `/rainbow.implement`
- If only LOW/MEDIUM: User may proceed, but provide improvement suggestions
- Provide explicit command suggestions: e.g., "Run /rainbow.specify with refinement", "Run /rainbow.design to adjust architecture", "Manually edit tasks.md to add coverage for 'performance-metrics'"
