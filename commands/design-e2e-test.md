...
2. **Load context**: Read `/memory/ground-rules.md`, `docs/architecture.md`, and all feature specifications from `/specs/*/spec.md`. Load E2E_TEST_DOC template (already copied to docs/).
